  ...
  return (
    <div className="group relative bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md hover:shadow-xl border-2 border-gray-200 overflow-hidden transition-all duration-300 hover:-translate-y-0.5">
      ...
      <div className="relative p-6">
        ...
        <p className="text-gray-900 leading-relaxed mb-5 font-medium text-lg">
          {devlog.content}
        </p>

        {devlog.media_url && (
          <div
            className="relative rounded-xl overflow-hidden border-2 border-gray-200 shadow-md bg-gray-50 flex items-center justify-center max-w-md"

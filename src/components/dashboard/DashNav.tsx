...
function DashItem({ href, Icon, label, disabled }: DashItemProps) {
  return (
    ...
    >
      <div
        className={`px-5 py-2.5 rounded-xl bg-gradient-to-br from-[#DC143C] to-[#8B0000] text-white text-center transition-all inline-flex items-center justify-center text-base md:text-lg focus:outline-none focus:ring-4 focus:ring-[#FFD700] focus:ring-offset-2 shadow-lg font-black tracking-wide${
          disabled

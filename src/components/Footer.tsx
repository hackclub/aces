  ...
  return (
    <footer className="relative w-full text-center bg-gradient-to-b from-[#590019] to-[#0F1419] p-6 text-white flex flex-col items-center justify-center gap-3 border-t-4 border-[#DC143C] overflow-hidden">
      ...
      <p className="relative z-10 md:text-lg text-md leading-relaxed font-medium">
        Made with love by{" "}
        <span className="font-bold text-[#FFD700]">Hack Club</span>. Check out
        our{" "}
        <a
          className="text-[#FFD700] hover:text-white underline decoration-2 underline-offset-4 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#FFD700] rounded px-1"
          href="https://github.com/hackclub/aces"
        >
          GitHub
        </a>
        , and the{" "}
